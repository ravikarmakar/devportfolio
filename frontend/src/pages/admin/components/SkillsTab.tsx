      ...
      <div className="container mx-auto px-2 py-6">
        ...
        <div className="container mx-auto px-4 py-6">
          <motion.h2
            ...
            className="text-2xl font-bold text-gray-800 dark:text-white mb-6 border-b pb-2"
          >
            Categories
          </motion.h2>
            ...
            >
              {Categories.map((category) => (
                <motion.div
                  ...
                  whileHover="hover"
                  className="dark:bg-gray-800 bg-[#272a2e] rounded-xl shadow-lg overflow-hidden"
                >
                  <div className="p-6">
